...
function ProductDetails() {
  ...
  useEffect(() => {
    ...
    fetch(`https://server3-route-omkar-07-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/productsById/${p_Id}`)
      .then((res) => res.json())
      .then((data) => {
        setProduct(data);
    ...
    fetch(`https://server3-route-omkar-07-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/productDetailsById/${p_Id}`)
      .then((res) => res.json())
      .then((data) => {
      ...
      fetch(`https://server3-route-omkar-07-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/getbyemail/${email_id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleAddToCart = () => {
    ...
    if (productDetails) {
      ...
      fetch('https://server3-route-omkar-07-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/add', {
        method: 'POST',
        headers: {
